...
interface MediaTypeInterface extends PluginInspectionInterface, ConfigurablePluginInterface, PluginFormInterface {
  ...
  /**
   * Checking if thumbnail should be updated.
   *
   * Logic to determine if thumbnail should be updated or not is responsibility
   * of media type, same as creation of thumbnail.
   *
   * @param \Drupal\media_entity\MediaInterface $media
   *    Media entity object.
   * @param \Drupal\media_entity\MediaInterface $originalMedia
   *    Original media entity object. It exists only in case of entity update.
   *
   * @return bool
   *   Returns true, if thumbnail should be updated.
   */
